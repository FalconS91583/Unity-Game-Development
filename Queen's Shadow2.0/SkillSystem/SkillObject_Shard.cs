...
public class SkillObject_Shard : SkillObject_Base
{
    ...
    public void MoveTowardClosestTarget(float speed, Transform newTarget = null)
    {
    ...
    public void SetupShard(Skill_Shard shardManager)
    {
        ...
        float detonationTime = shardManager.GetDetotanteTime();
    ...
    public void SetupShard(Skill_Shard shardManager, float detonationTime, bool canMove, float shardSpeed, Transform target = null)
    {
        ...
        if (canMove)
            MoveTowardClosestTarget(shardSpeed, target);
    }
    public  void Explode()
    {
