...
public class UI_SkillTree : MonoBehaviour, ISaveable
{
    ...
    [SerializeField] private UI_TreeConnectedHandler[] parentNodes;
    ...
    [ContextMenu("Update All Conections")]
    ...
    public void LoadData(GameData data)
    {
        ...
        foreach (var skill in skillManager.allSkills)
        {
            ...
            {
                var upgradeNode = 
                    allTreeNodes.FirstOrDefault(node => node.skillData.upgradeData.upgradeType == upgradeType);
